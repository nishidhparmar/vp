...
const Footer = () => {
    return (
        <div className='w-full bg-dark-blue p-section-padding-x py-10 flex mt-10'>

            <div className='w-1/2 text-netural-white'>
                <p className='text-netural-white font-semibold text-5xl mb-4'>VATSAL & PARTNER</p>
                <p className='text-netural-white/80 text-sm'>7223 Dishley Crt,<br />
                    Mississauga ON L5N 7X3</p>
                <p className='mt-4 text-netural-white/80 text-sm'>416-606-0079
                </p>
                <p className='text-netural-white/80 text-sm'>vatsal@pinnacletaxcpa.com</p>
            </div>
            <div className='w-1/2 flex'>
                <div className='w-1/2 flex flex-col'>
                    <p className='text-netural-white font-semibold text-lg'>Site Map</p>
                    <div className='space-y-2 flex flex-col mt-4 text-netural-white/80 text-sm'>
                        ...
                        <Link className='hover:underline' href={'/'} >CUSTOM REVIEW</Link>
